...
const projects = [
  { title: "Portfolio", desc: "A full-stack ChatGPT-like conversational AI web app built with Django and Next.js.", tech: ["Django", "Next.js", "Python", "AI"] },
  { title: "Whisperfy", desc: "A web app for converting speech to text & audio extraction using Whisper AI.", tech: ["Django", "HTML", "Whisper"] },
